 ...
 *
*/
#ifndef _GAZEBO_FIN_LIFT_DRAG_PLUGIN_HH_
#define _GAZEBO_FIN_LIFT_DRAG_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE FinLiftDragPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    ...
    protected: void WindSpeedCallback(GzWindSpeedMsgPtr& wind_speed_msg);
    ...
    protected: void CreatePubsAndSubs();
    ...
    protected: ignition::math::Vector3d wind_speed;
