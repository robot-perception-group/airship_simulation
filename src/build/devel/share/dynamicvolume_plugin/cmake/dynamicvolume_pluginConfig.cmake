...
if(NOT "/home/yliu2/gazebo_plugin_tutorial/include;/usr/include/eigen3;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamicvolume_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yliu2/gazebo_plugin_tutorial/${idir}'.  ${_report}")
    endif()
