...
class BlimpPythonNode(object):
    ...
    def _create_pubs_subs(self):
        ...
        """ create subscibers """
        rospy.Subscriber(
            "/blimp/command/motor1_speed_matlab",
            Float64,
            self._motor1_speed_callback)
        rospy.Subscriber(
            "/blimp/command/motor2_speed_matlab",
            Float64,
            self._motor2_speed_callback)
        rospy.Subscriber(
            "/blimp/command/motor3_speed_matlab",
            Float64,
            self._motor3_speed_callback)
